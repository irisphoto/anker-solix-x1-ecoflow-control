      ...
      <AreaChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        <defs>
          ...
          <linearGradient id="gExport" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="hsl(152 70% 45%)" stopOpacity={0.4} />
        ...
        <Area type="monotone" dataKey="grid_export_w" name="Grid export" stroke="hsl(152 70% 45%)" fill="url(#gExport)" strokeWidth={2} />
