        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-3 gap-3 mb-3">
              ...
              <div className="rounded-lg border border-border/70 p-2.5">
                <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
                  <BatteryCharging className="w-3.5 h-3.5" style={{ color: "hsl(152 62% 40%)" }} /> Charging
                </div>
            ...
            <ResponsiveContainer width="100%" height={260}>
              <ComposedChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                ...
                <Area yAxisId="w" type="monotone" dataKey="charge" name="Discharging" stroke="hsl(217 91% 55%)" fill="url(#gBattCharge)" strokeWidth={2} />
                <Area yAxisId="w" type="monotone" dataKey="discharge" name="Charging" stroke="hsl(152 62% 40%)" fill="url(#gBattDischarge)" strokeWidth={2} />
